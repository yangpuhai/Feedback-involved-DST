        ...
        for ti, turn in enumerate(dial_dict["dialogue"]):
            ...
            if data_type == 'train':
                ...
                if fid in feedback_set:
                    ...
                    for s in feedback_set[fid]["belief_state"]:
                        if s['act'] == 'inform':
                            new_turn_dialog_state[s['slots'][0][0]] = s['slots'][0][1]
                    ...
                    instance = TrainingInstance(dialogue_id, turn_id, " ; ".join(dialog_history) + ' ' + feedback_set[fid]["feedback"], 
